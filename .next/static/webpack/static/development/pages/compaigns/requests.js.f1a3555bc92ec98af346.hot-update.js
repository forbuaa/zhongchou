...
function (_React$Component) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              _context2.next = 6;
              return campaign.methods.finalRequest(_this.props.id).send({
                from: accounts[0]
              });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(RequestRow, [{
    ...
    value: function render() {
      ...
      }, __jsx(Cell, null, id), __jsx(Cell, null, request.description), __jsx(Cell, null, _ethereum_web3__WEBPACK_IMPORTED_MODULE_11__["default"].utils.fromWei(request.value, 'ether')), __jsx(Cell, null, request.recipients), __jsx(Cell, null, request.approvalCount, "/", approvesCount), __jsx(Cell, null, request.complete ? null : __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        color: "green",
        onClick: this.onApprove
      }, " \xA0\u540C\u610F ")), __jsx(Cell, null, request.complete ? null : __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        color: "teal",
...
//# sourceMappingURL=requests.js.f1a3555bc92ec98af346.hot-update.js.map